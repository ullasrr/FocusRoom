  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <div
          onClick={onClick}
          className="flex items-center justify-center w-12 h-12 bg-slate-900 hover:bg-slate-700/70 rounded-lg cursor-pointer transition-all duration-200 ease-in-out hover:shadow-md group"
        >
          <div
